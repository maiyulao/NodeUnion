...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "airportDesc": MessageLookupByLibrary.simpleMessage(
      "Open your airport site inside app",
    ),
    "airportNotConfigured": MessageLookupByLibrary.simpleMessage(
      "Airport service URL is not configured. Please try again later.",
    ),
    "airportWebviewUnsupported": MessageLookupByLibrary.simpleMessage(
      "Embedded WebView is unavailable on this platform. You can open the site in an external browser.",
    ),
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "A subscription proxy client forked from FlClash, with built-in access to proxy service providers.",
    ),
    ...
    "thanksOriginalProjectDesc": MessageLookupByLibrary.simpleMessage(
      "This app is forked from FlClash. Thanks to the original authors and community for their open-source contributions.",
    ),
