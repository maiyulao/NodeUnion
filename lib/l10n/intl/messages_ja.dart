...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "airport": MessageLookupByLibrary.simpleMessage("エアポート"),
    "airportDesc": MessageLookupByLibrary.simpleMessage("アプリ内であなたの空港サイトを開く"),
    "airportNotConfigured": MessageLookupByLibrary.simpleMessage(
      "サービス URL が未設定です。しばらくしてから再度お試しください。",
    ),
    "airportWebviewUnsupported": MessageLookupByLibrary.simpleMessage(
      "このプラットフォームでは内蔵 WebView を利用できません。外部ブラウザで開いてください。",
    ),
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "FlClash をベースに二次開発したプロキシサービスクライアント。アプリ内からサービスにアクセスできます。",
    ),
    ...
    "originalCommunity": MessageLookupByLibrary.simpleMessage("FlClash コミュニティ"),
    "originalProject": MessageLookupByLibrary.simpleMessage("FlClash 原プロジェクト"),
    ...
    "thanksOriginalProjectDesc": MessageLookupByLibrary.simpleMessage(
      "本アプリは FlClash をベースに二次開発されています。原プロジェクトの作者とコミュニティのオープンソースへの貢献に感謝します。",
    ),
