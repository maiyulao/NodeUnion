...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "airport": MessageLookupByLibrary.simpleMessage("Аэропорт"),
    "airportDesc": MessageLookupByLibrary.simpleMessage(
      "Открыть сайт вашего аэропорта внутри приложения",
    ),
    "airportNotConfigured": MessageLookupByLibrary.simpleMessage(
      "URL сервиса не настроен. Пожалуйста, повторите попытку позже.",
    ),
    "airportWebviewUnsupported": MessageLookupByLibrary.simpleMessage(
      "Встроенный WebView недоступен на этой платформе. Откройте сайт во внешнем браузере.",
    ),
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "Прокси-клиент для подписок, форк FlClash со встроенным доступом к сервисам провайдеров.",
    ),
    ...
    "originalCommunity": MessageLookupByLibrary.simpleMessage(
      "Сообщество FlClash",
    ),
    "originalProject": MessageLookupByLibrary.simpleMessage(
      "FlClash (оригинал)",
    ),
    ...
    "thanksOriginalProject": MessageLookupByLibrary.simpleMessage(
      "Благодарности",
    ),
    "thanksOriginalProjectDesc": MessageLookupByLibrary.simpleMessage(
      "Это приложение является форком FlClash. Благодарим авторов оригинального проекта и сообщество за вклад в открытый исходный код.",
    ),
