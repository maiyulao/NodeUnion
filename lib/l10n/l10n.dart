...
class AppLocalizations {
  ...
  /// `Airport`
  String get airport {
    return Intl.message('Airport', name: 'airport', desc: '', args: []);
  }

  /// `Open your airport site inside app`
  String get airportDesc {
    return Intl.message(
      'Open your airport site inside app',
      name: 'airportDesc',
      desc: '',
  ...
  String get airportNotConfigured {
    return Intl.message(
      'Airport service URL is not configured. Please try again later.',
      name: 'airportNotConfigured',
      desc: '',
      args: [],
    );
  }
  ...
  String get airportWebviewUnsupported {
    return Intl.message(
      'Embedded WebView is unavailable on this platform. You can open the site in an external browser.',
      name: 'airportWebviewUnsupported',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Acknowledgments`
  String get thanksOriginalProject {
    return Intl.message(
      'Acknowledgments',
      name: 'thanksOriginalProject',
      desc: '',
      args: [],
    );
  }
  ...
  String get thanksOriginalProjectDesc {
    return Intl.message(
      'This app is forked from FlClash. Thanks to the original authors and community for their open-source contributions.',
      name: 'thanksOriginalProjectDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `FlClash Community`
  String get originalCommunity {
    return Intl.message(
      'FlClash Community',
      name: 'originalCommunity',
      desc: '',
      args: [],
    );
  }
