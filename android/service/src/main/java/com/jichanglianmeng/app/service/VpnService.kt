...
import com.jichanglianmeng.app.common.AccessControlMode
...
import com.jichanglianmeng.app.service.models.getIpv4RouteAddress
import com.jichanglianmeng.app.service.models.getIpv6RouteAddress
import com.jichanglianmeng.app.service.models.toCIDR
import com.jichanglianmeng.app.service.modules.NetworkObserveModule
import com.jichanglianmeng.app.service.modules.NotificationModule
import com.jichanglianmeng.app.service.modules.SuspendModule
import com.jichanglianmeng.app.service.modules.moduleLoader
...
class VpnService : SystemVpnService(), IBaseService,
    ...
    private fun handleStart(options: VpnOptions) {
        val fd = with(Builder()) {
            ...
            setSession(getString(com.jichanglianmeng.app.common.R.string.app_name))
            setBlocking(false)
