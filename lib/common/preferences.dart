...
class Preferences {
  ...
  Future<String?> getBrandConfigCache() async {
    try {
      final preferences = await sharedPreferencesCompleter.future;
      return preferences?.getString('brand_config_cache');
    } catch (_) {
      return null;
    }
  }

  Future<void> setBrandConfigCache(String value) async {
    final preferences = await sharedPreferencesCompleter.future;
    await preferences?.setString('brand_config_cache', value);
  }
}
